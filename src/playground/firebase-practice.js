...
// //Subscription listening for a child removed
// database.ref('expenses').on('child_removed', (snapshot) => { //listening on expenses for a removed item
//     console.log(snapshot.key, snapshot.val())
// });
// //end


// //Subscription listening for a child changed
// database.ref('expenses').on('child_changed', (snapshot) => {
//     console.log(snapshot.key, snapshot.val());
// });
// //end

// //Subscription listening for new children added
// database.ref('expenses').on('child_added', (snapshot) => { //fires one time for all the data already at that location
//     console.log(snapshot.key, snapshot.val());
// });

// //subscribing and transforming to arrays
